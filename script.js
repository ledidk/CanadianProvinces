...
const content = {
  ...
  const provincesFr = [
    ...
    { name: "Colombie-Britannique", details: "La Colombie-Britannique offre des paysages variés, des montagnes aux régions côtières." },
    { name: "Manitoba", details: "Le Manitoba est connu pour ses magnifiques lacs et ses paysages de prairies." },
    { name: "Nouveau-Brunswick", details: "Le Nouveau-Brunswick est célèbre pour ses côtes pittoresques et ses charmantes villes." },
    { name: "Terre-Neuve-et-Labrador", details: "Terre-Neuve-et-Labrador offre des paysages côtiers à couper le souffle." },
    { name: "Nouvelle-Écosse", details: "La Nouvelle-Écosse est connue pour ses sites historiques, ses fruits de mer et sa beauté pittoresque." },
    { name: "Ontario", details: "L'Ontario est la province la plus peuplée du Canada et abrite la vibrante ville de Toronto." },
    { name: "Île-du-Prince-Édouard", details: "L'Île-du-Prince-Édouard est célèbre pour ses plages de sable rouge et Anne aux pignons verts." },
